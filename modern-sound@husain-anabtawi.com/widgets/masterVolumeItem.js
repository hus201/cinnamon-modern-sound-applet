...
const { volumeIconName } = require("./widgets/volume");

const SLIDER_WIDTH = 140;
const SLIDER_HEIGHT = 22;

class MasterVolumeItem extends PopupMenu.PopupBaseMenuItem {
    constructor(applet) {
    ...
    _sync() {
        ...
        this._icon.icon_name = volumeIconName(value, this._stream.is_muted);
    ...
    _onChanged(value) {
        ...
        this._percentLabel.text = `${percent}%`;
        this._icon.icon_name = volumeIconName(value, muted);
...
module.exports = { MasterVolumeItem };
